            ...
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal">{{ Auth::guard('atasan_pejabat_penilai')->user()->name }}</h5>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="{{ asset('../../assets/images/faces/face15.jpg') }}" alt="">
                    <p class="mb-0 d-none d-sm-block navbar-profile-name">{{ Auth::guard('atasan_pejabat_penilai')->user()->name }}</p>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Dashboard Atasan Pejabat Penilai </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Komponen Penilaian Pekerjaan</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Dashboard Atasan Pejabat Penilai</li>
                </ol>
              </nav>
            </div>
