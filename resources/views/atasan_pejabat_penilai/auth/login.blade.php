              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                  ...
                  <form method="POST" action="{{ route('atasan_pejabat_penilai.logout') }}">
                    @csrf
                    <a class="dropdown-item preview-item" :href="route('atasan_pejabat_penilai.logout')"
            ...
            <div class="row">
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-description"> Login sebagai Atasan Pejabat Penilai </p>

                        <!-- form login -->
                        <form class="forms-sample" method="POST" action="{{ route('atasan_pejabat_penilai.login') }}">
                            @csrf
                            ...
                            <div class="flex items-center justify-end mt-4">
                                @if (Route::has('password.request'))
                                    <a class="underline text-sm text-gray-600 hover:text-gray-900 mb-4" href="{{ route('atasan_pejabat_penilai.password.request') }}">
