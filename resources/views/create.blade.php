            ...
            <div class="row">
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-description"> Lengkapi Data dibawah ini untuk melanjutkan ke Dashboard</p>

                        <!-- form login -->
                        <form class="forms-sample" action="{{ route('dashboard.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="exampleInputEmail1">Nama</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nama" name="nama" value="{{ Auth::user()->name }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="flex items-center justify-end mt-4">
                                @if (Route::has('password.request'))
                                    <a class="underline text-sm text-gray-600 hover:text-gray-900 mb-4" href="{{ route('password.request') }}">
