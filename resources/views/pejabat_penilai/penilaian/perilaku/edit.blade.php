          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Penilaian Perilaku Form</h4>
                    <p class="card-description"> Basic form layout </p>

                    <!-- create form -->
                    <form class="forms-sample" action="{{ route('penilaian.perilaku.update', $perilaku->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="exampleInputUsername1">Nama</label>
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Nama"
                                name="nama" value="{{ $perilaku->nama }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername1">NIP</label>
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="NIP"
                                name="nip" value="{{ $perilaku->nip }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername1">Perilaku</label>
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="perilaku"
                                name="perilaku" value="{{ $perilaku->perilaku }}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="penilaian"
                                name="penilaian_perilaku" value="{{ $perilaku->penilaian_perilaku }}">
                        </div>
