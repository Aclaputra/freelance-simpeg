                    ...
                    <form class="forms-sample" action="{{ route('penilaian.iku.update', $iku->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Nama"
                                name="nama" value="{{ $iku->nama }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername1">NIP</label>
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="NIP"
                                name="nip" value="{{ $iku->nip }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername1">Indikator Kinerja Utama</label>
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="iku"
                                name="iku" value="{{ $iku->iku }}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="penilaian"
                                name="penilaian_iku" value="{{ $iku->penilaian_iku }}">
                        </div>
