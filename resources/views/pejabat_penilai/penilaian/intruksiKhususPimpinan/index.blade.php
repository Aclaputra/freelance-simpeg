        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Intruksi Khusus Pimpinan </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Komponen Penilaian Pekerjaan</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Intruksi Khusus Pimpinan (IKP)</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Tabel Penilaian Intruksi Khusus Pimpinan (IKP)</h4>
                      ...
                      <table class="table table-striped">
                        <thead>
                          <tr>
                            ...
                            <th> Nama </th>
                            <th> NIP </th>
                            <th> Intruksi Khusus Pimpinan (IKP) </th>
                            <th> Penilaian </th>
                            <th> Aksi </th>
                          </tr>
                        </thead>
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td> {{ $data->ikp }} </td>
                            <td> {{ $data->penilaian_ikp }}</td>
                            <td>
                              <a href="{{ url('pejabat_penilai/dashboard/komponen_penilaian_pekerjaan/ikp/' . $data->id . '/edit') }}">
