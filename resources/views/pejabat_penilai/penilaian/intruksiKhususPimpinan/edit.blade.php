          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Penilaian Intruksi Khusus Pimpinan Form</h4>
                    <p class="card-description"> Basic form layout </p>

                    <!-- create form -->
                    <form class="forms-sample" action="{{ route('penilaian.ikp.update', $ikp->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="exampleInputUsername1">Nama</label>
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Nama"
                                name="nama" value="{{ $ikp->nama }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername1">NIP</label>
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="NIP"
                                name="nip" value="{{ $ikp->nip }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername1">Intruksi Khusus Pimpinan</label>
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="ikp"
                                name="ikp" value="{{ $ikp->ikp }}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="penilaian"
                                name="penilaian_ikp" value="{{ $ikp->penilaian_ikp }}">
                        </div>
