        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Indikator Kinerja Individu </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Komponen Penilaian Pekerjaan</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Indikator Kinerja Individu (IKI)</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Tabel Penilaian Indikator Kinerja Individu (IKI)</h4>
                      ...
                      <table class="table table-striped">
                        <thead>
                          <tr>
                            ...
                            <th> Nama </th>
                            <th> NIP </th>
                            <th> Indikator Kinerja Individu (IKI) </th>
                            <th> Penilaian </th>
                            <th> Aksi </th>
                          </tr>
                        </thead>
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td> {{ $data->iki }} </td>
                            <td> {{ $data->penilaian_iki }}</td>
                            <td>
                              <a href="{{ url('pejabat_penilai/dashboard/komponen_penilaian_pekerjaan/iki/' . $data->id . '/edit') }}">
