          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Penilaian Indikator Kinerja Individu Form</h4>
                    <p class="card-description"> Basic form layout </p>

                    <!-- create form -->
                    <form class="forms-sample" action="{{ route('penilaian.iki.update', $iki->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="exampleInputUsername1">Nama</label>
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Nama"
                                name="nama" value="{{ $iki->nama }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername1">NIP</label>
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="NIP"
                                name="nip" value="{{ $iki->nip }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername1">Indikator Kinerja Individu</label>
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="iki"
                                name="iki" value="{{ $iki->iki }}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="penilaian"
                                name="penilaian_iki" value="{{ $iki->penilaian_iki }}">
                        </div>
