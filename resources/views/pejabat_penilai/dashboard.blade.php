          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ route('penilaian.aktivitas.dashboard') }}">Aktivitas</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('penilaian.iku.dashboard') }}">IKU</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('penilaian.realisasi.dashboard') }}">Realisasi</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('penilaian.perilaku.dashboard') }}">Perilaku</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('penilaian.iki.dashboard') }}">IKI</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('penilaian.ikp.dashboard') }}">IKP</a></li>
              </ul>
            </div>
          </li>
