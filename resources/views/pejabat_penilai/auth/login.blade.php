      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route('pejabat_penilai.login') }}">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route('pejabat_penilai.register') }}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
            ...
            <div class="row">
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-description"> Login sebagai Pejabat Penilai </p>

                        <!-- form login -->
                        <form class="forms-sample" method="POST" action="{{ route('pejabat_penilai.login') }}">
                            @csrf
                            ...
                            <div class="flex items-center justify-end mt-4">
                                @if (Route::has('password.request'))
                                    <a class="underline text-sm text-gray-600 hover:text-gray-900 mb-4" href="{{ route('pejabat_penilai.password.request') }}">
