              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                  ...
                  <form method="POST" action="{{ route('kepala_urusan_kepegawaian.logout') }}">
                    @csrf
                    <a class="dropdown-item preview-item" :href="route('kepala_urusan_kepegawaian.logout')"
            ...
            <div class="row">
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-description"> Register sebagai Kepala Urusan Kepegawaian </p>

                        <!-- form Register -->
                        <form class="forms-sample" method="POST" action="{{ url('kepala_urusan_kepegawaian/register') }}">
                            @csrf
                            <div class="form-group">
                                <label for="exampleText">Nama</label>
                                <input type="text" class="form-control" id="exampleName" placeholder="Nama" name="name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="flex items-center justify-end mt-4">
                                <a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ url('kepala_urusan_kepegawaian/login') }}">
                                    {{ __('Already registered?') }}
                                </a>
                            </div>
                            <button type="submit" class="btn btn-primary mr-2 mt-4">Register</button>
                            <button class="btn btn-dark mt-4">Cancel</button>
                        </form>
                    </div>
                    </div>
                </div>
