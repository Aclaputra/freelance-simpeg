            ...
            <div class="row">
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-description"> Login sebagai Kepala Urusan Kepegawian </p>

                        <!-- form login -->
                        <form class="forms-sample" method="POST" action="{{ route('kepala_urusan_kepegawaian.login') }}">
                            @csrf
                            ...
                            <div class="flex items-center justify-end mt-4">
                                @if (Route::has('password.request'))
                                    <a class="underline text-sm text-gray-600 hover:text-gray-900 mb-4" href="{{ route('kepala_urusan_kepegawaian.password.request') }}">
                                        {{ __('Forgot your password?') }}
                                    </a>
                                @endif
                            </div>
                            <button type="submit" class="btn btn-primary mr-2 mt-4">Login</button>
